...
# @tags: codex,hooks
# @kind: gotcha
# @lore: Codex 0.142.5 marks SessionStart stdout failed even for JSON accepted by other
# harnesses; keep Codex silent until its hook contract supports injection.
fmt="${1:-claude}"
