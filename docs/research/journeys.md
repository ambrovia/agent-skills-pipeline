...
journeys through that space, and maps the 20 improvement ideas (work-groups.md) against them.
...
## Mapping: 20 ideas × 5 journeys

● = primary help, ○ = secondary, — = not relevant. Rows 4–5, 10–12, 17, 20 are preliminary.
...
| 17 | Loop continuity (durable loop agents) | ○ | ● | ● | ● | ○ |
| 18 | Verify-in-build hooks | ● per-fix checks | ○ | ○ | ● conformance to procedure | ○ |
| 19 | Human-gate rebalance | — | ● decision gates | ● concept/final | ○ pattern approval | ● the decide moment |
| 20 | Pre-spawn check runs | ● per-fix pre-check | ○ | ● | ● conformance pre-check | ○ |

## Observations from the mapping

1. **Ideas 1, 3, 9, 10, 11, 12, 13, 18 are the journey-shapers** — they differentiate most
...
2. **Ideas 2, 4, 5, 14, 15, 16, 17, 19, 20 are journey-agnostic infrastructure** — they should
   land once and serve every journey.
