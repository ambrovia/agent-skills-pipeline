...
6. **WP: Skills governance audit.** Outcome: every skill audited against HANDBOOK.md failure modes [10]; oversized skills split; references lazy-loaded; always-loaded token count measured before/after. Acceptance: no SKILL.md exceeds the agreed line budget; measured token overhead drops; gates remain mechanical.
