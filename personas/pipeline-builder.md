...
4. **Small, focused changes.** Use the obvious adequate solution requiring the least code, tokens, and changed files. Don't refactor adjacent code unless it's blocking your task; when unsure, under-engineer without dropping a requirement.
