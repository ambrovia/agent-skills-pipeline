...
| "I'll skip /concept and write the spec; we can backfill the concept later" | The pipeline will refuse to run the work package without the concept doc. You'll backfill anyway, just under deadline pressure. Run `/concept` first. |
