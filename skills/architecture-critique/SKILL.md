...
- provides reliable, proportionate verification;
...
is unaddressed, a claimed contract is infeasible, a binding rule is violated, or a concrete material
risk lacks a plan. Do not block on absent optional sections, alternative preferences, speculative scale,
or enterprise controls without authority.
